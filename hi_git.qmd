...
-   Git is a distributed version control system
    ...
    ![](R_materials/images/meme1.jpeg){width="256"}
...
::: columns
::: {.column width="50%"}
-   As you work on a project, you make changes on what is called a *working directory*

-   Changes to your *working directory* must be staged before they can be committed
    ...
    -   ave the contents in the staging area with a COMMIT
:::

::: {.column width="50%"}
![](R_materials/images/staging.png){fig-align="center"}
:::
:::
